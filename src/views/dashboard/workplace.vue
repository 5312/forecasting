...
export default {
  ...
  data() {
    return {
      ...
      activities: [
        {
          title: 'v1.2.0版本发布， 新增代码生成器',
          timestamp: '20:30',
          primary: false
        },
        {
          title: 'v1.1.0版本发布， 新增广告模块',
          timestamp: '19:30',
          primary: false
        },
        {
          title: 'v1.0.9版本发布， 新增站点栏目',
          timestamp: '18:30',
          primary: true
        },
        {
          title: 'v1.0.8版本发布，新增会员管理',
          timestamp: '17:30',
          primary: true
        },
        {
          title: 'v1.0.7版本发布，新增城市模块',
          timestamp: '16:30',
          primary: true
        },
        {
          title: 'v1.0.6版本发布，新版架构调整',
          timestamp: '15:30',
          primary: false
        },
        {
          title: 'v1.0.5版本发布，新增用户管理',
          timestamp: '14:30',
          primary: false
        },
        {
          title: 'v1.0.4版本发布，新增权限设置',
          timestamp: '12:30',
          primary: false
        },
        {
          title: 'v1.0.3版本发布，新增角色管理',
          timestamp: '11:30',
          primary: true
        },
        {
          title: 'v1.0.2版本发布，新增部门管理',
          timestamp: '10:30',
          primary: false
        },
        {
          title: 'v1.0.1版本发布，新增职级管理模块',
          timestamp: '09:30',
          primary: false
        },
        {
          title: 'v1.0.0版本发布，系统框架搭建',
          timestamp: '08:30',
          primary: false
        }
      ],
      ...
      projectList: [
        ...
        {
          projectName: '新能源汽车设计大赛',
          state: 2, startDate: '2020-01-01',
          endDate: '2020-03-01',
          progress: 100
        },
        {
          projectName: 'SpaceX火箭发射计划',
          state: 3,
          startDate: '2020-01-01',
          endDate: '2020-03-01',
          progress: 100
